    ...
    <div className="flex flex-col h-full bg-nai-bg">
      ...
      {showSaveSettings && (
        <div
          ...
          onClick={() => setShowSaveSettings(false)}
        >
          <div
          ...
          >
                ...
                {saveFormat === 'jpg' && (
                  <div className="mt-3 px-1">
                    ...
                    <input
                      ...
                      onChange={(e) => setSaveQuality(Number(e.target.value) / 100)}
            ...
            <div className="px-4 pb-6 pt-2">
              <button
                onClick={handleApplySaveSettings}
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              {(isGenerating || isQueuing) && (
                <div
                  ...
                  onClick={() => { setViewingHistory(false); setIsGalleryExpanded(false); }}
                >
                  {previewUrl ? (
                    <img src={previewUrl} alt="生成中" className="w-full h-full object-cover" />
                  ) : (
