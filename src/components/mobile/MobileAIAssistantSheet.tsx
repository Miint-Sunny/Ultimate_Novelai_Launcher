...
import { TypewriterText, renderMessageContent } from './ai-assistant/AssistantMessageParts';
...
// TypewriterText / TagButton / renderMessageContent 已抽到 ./ai-assistant/AssistantMessageParts.tsx。
