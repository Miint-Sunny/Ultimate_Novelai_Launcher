      ...
      >
        {showTaggerResult && taggerResult ? (
          <>
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-700">
              <div className="flex items-center gap-2">
                <button onClick={() => setShowTaggerResult(false)} className="p-1.5 text-gray-400 active:text-white">
          ...
          <>
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-700">
              <div className="flex items-center gap-2">
                <button onClick={() => setShowFullMetadata(false)} className="p-1.5 text-gray-400 active:text-white">
                  <ArrowLeft className="w-5 h-5" />
                </button>
          ...
          <>
            <div className="flex gap-3 p-4 border-b border-gray-700">
              ...
              <div className="flex-1 min-w-0">
                ...
                <button onClick={() => setShowFullMetadata(true)} className="text-xs text-nai-accent active:opacity-70 mt-2">
                  查看完整元数据
                </button>
              </div>
            </div>
          ...
          <>
            ...
            {isParsingMetadata ? (
              ...
              <div className="p-4 pb-8 space-y-3 safe-area-bottom">
                ...
                <UseAsButtons stacked {...useAsProps} />
              </div>
            )}
          </>
        )}
